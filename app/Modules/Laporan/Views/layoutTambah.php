        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-inverse" style="background-color: #ff5148;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="<?= base_url('/Laporan') ?>">Data</a>
                    </li>
                    <li class="nav-item">
                        <!-- Perbedaan layoutTambah dengan layout adalah pada class dibawah ini -->
                        <a class="nav-link active" aria-current="page" href="<?= base_url('/Laporan/tambah') ?>">Tambah</a> 
                    </li>
